...
def recommend():
    ...
    '''call the convert_to_list function
    for every string that needs to be converted to list'''
    ...
    """combining multiple lists as a dictionary which can be
    passed to the html file so that it can be processed
